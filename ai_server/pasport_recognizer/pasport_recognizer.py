...
def recognize_passport_text(image):
    ...
    # Инициализируем EasyOCR с gpu=True, если CUDA доступна (для тестового вызова можно оставить gpu=False)
...
# Новый класс для интеграции с API
class PassportRecognizer:
    def __init__(self):
        import torch
        # Используем GPU, если доступна CUDA, иначе CPU
...
# Тестирование через камеру (не изменяем)
def main():
